  ...
  <aside class="main-sidebar fixed-top">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('co_leader/profile/profile'); ?>">Profil Desa</a></li>
            <li><a href="#">Profil Admin</a></li>
          </ul>
        </li>

        <li class=""><a href="<?php echo site_url('admin/barang'); ?>"><i class="fa fa-list-alt"></i> <span>Stok barang</span></a></li>

        <li class=""><a href="<?php echo site_url('admin/peminjam'); ?>"><i class="fa fa-users"></i> <span>Peminjam</span></a></li>

        <li class=""><a href="<?php echo site_url(''); ?>"><i class="fa fa-bell"></i> <span>Pemberitahuan</span></a></li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="<?php echo site_url('guru/members'); ?>"><i class="fa fa-sticky-note-o"></i> <span>Data Member</span></a></li>
